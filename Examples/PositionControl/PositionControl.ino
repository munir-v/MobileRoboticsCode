...
PositionControl positionControl(
   GOALX, GOALY, GOAL_THRESHOLD, TRACK_WIDTH, MAX_LINEAR_VELOCITY, MAX_ANGULAR_VELOCITY, K_POSITION, K_ORIENTATION, TRACK_WIDTH, POSITION_CONTROL_INTERVAL);
...
void loop()
{
   ...
   if (updateVelocities) {
       motorControl.setTagetVelocity(leftVelocity, rightVelocity);
   }
